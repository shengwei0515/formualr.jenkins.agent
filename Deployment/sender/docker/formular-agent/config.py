...
MQ_HOST =  '192.168.1.105' if os.environ.get("MQ_HOST") == None else os.environ.get("MQ_HOST")
...
FORMULAR_ENDPOINT = 'https://192.168.1.105:5001' if os.environ.get("FORMULAR_ENDPOINT") == None else os.environ.get("FORMULAR_ENDPOINT")
